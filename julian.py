...
# code copied from web... https://pypi.org/project/julian/ , I did some modification because there is a bug in the package, see https://github.com/dannyzed/julian/issues/4

def __to_format(jd, fmt):
    """
